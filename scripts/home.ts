...
const Register_Button = document.getElementById("Register_Button") as HTMLButtonElement;
const Login_Button = document.getElementById("Login_Button") as HTMLButtonElement;
const ForStudents_Button = document.getElementById("ForStudents_Button") as HTMLButtonElement;
