...
import { PROFILE_FIRSTNAME, PROFILE_LASTNAME, PROFILE_PHOTO, NEW_TRANSMUTATION_BUTTON, LOGOUT_BUTTON, TRANSMUTATION_MODAL, DELETE_MODAL, ERROR_MODAL, TRANSMUTATION_LIST, } from "./dom";
...
function EditTransmutationInit(transmutation) {
    ...
    Displays.Passing.innerText = LinearScale(transmutation.lowest, transmutation.highest, 0, 100, transmutation.passing)
        .toFixed(2)
        .toString();
...
function DeleteTransmutationInit(transmutation) {
...
function populateList(transmutations) {
    ...
    for (let transmutation of transmutations) {
        ...
        Card.classList.add("w-max", "shadow-lg", "rounded", "bg-white", "border-2", "border-neutral-400", "p-3");
        const CardHeader = document.createElement("div");
        CardHeader.classList.add("w-full", "px-3", "mb-6", "text-lg", "font-semibold");
        CardHeader.innerText = transmutation.name;
        const Table = document.createElement("table");
        Table.classList.add("w-full", "table-auto", "whitespace-nowrap");
        const TableHeader = document.createElement("thead");
        TableHeader.classList.add("uppercase", "text-neutral-400", "text-md", "text-left");
    ...
    `;
      ...
      <tr>
          ...
          <td class='p-3 text-center font-mono'>${LinearScale(transmutation.lowest, transmutation.highest, 0, 100, transmutation.passing).toFixed(2)} %</td>
    ...
    `;
        ...
        CardButtons.classList.add("mt-5", "w-full", "flex", "flex-row", "justify-end", "text-white", "gap-2");
        const EditButton = document.createElement("button");
        EditButton.classList.add("rounded", "px-3", "py-2", "rounded", "shadow", "bg-blue-400", "hover:bg-blue-500");
        EditButton.innerHTML = "<i class='fa-solid fa-gear'></i>";
        EditButton.onclick = () => {
            EditTransmutationInit(transmutation);
        };
        const DeleteButton = document.createElement("button");
        DeleteButton.classList.add("rounded", "px-3", "py-2", "rounded", "shadow", "bg-red-400", "hover:bg-red-500");
